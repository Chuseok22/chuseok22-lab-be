...
public enum ErrorCode {
  ...
  MISSING_AUTH_TOKEN(HttpStatus.FORBIDDEN, "토큰이 존재하지 않습니다."),

  EXPIRED_ACCESS_TOKEN(HttpStatus.FORBIDDEN, "엑세스 토큰이 만료되었습니다."),
  ...
  COOKIES_NOT_FOUND(HttpStatus.UNAUTHORIZED, "쿠키가 존재하지 않습니다."),
  ...
  GITHUB_TOKEN_REQUIRED(HttpStatus.BAD_REQUEST, "Private 레포지토리에 접근하기위해 Token이 필요합니다."),

  INVALID_GITHUB_TOKEN(HttpStatus.BAD_REQUEST, "잘못된 Github Token이 요청되었습니다."),
